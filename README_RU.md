# ArenaMP Android Y001 r5 — main-safe сборщик

## Y001 r5 — оформление раздела «Помощь»

Раздел «Помощь» теперь явно обозначен как **ArenaMP (fork TES3MP)**. Чёрно-белые служебные иконки файла, производительности, сети и обновления заменены на PNG с прозрачным фоном в золотом объёмном стиле экранных кнопок; существующие золотые игровые иконки не изменялись.
